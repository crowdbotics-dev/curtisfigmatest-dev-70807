...
## Project Structure
    ...
    ├── curtisfigmatest_dev_70807  # Django project configurations
...
1. Clone this repo and `cd curtisfigmatest_dev_70807`
...
2. Clone this repo and `cd curtisfigmatest_dev_70807`
